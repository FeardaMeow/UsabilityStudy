...
body <- dashboardBody(
  ...
  tabItems(
    tabItem("LL",uiOutput("LLview"),
            numericInput("LLanswer", "Answer:", value=0, min=0, max=100),
            actionButton("LLcounter", "Submit")),
    tabItem("LH", uiOutput("LHtable"),
            numericInput("LHanswer", "Answer:", value=0, min=0, max=100),
            actionButton("LHcounter", "Submit")),
    tabItem("ML", uiOutput("MLview"),
            numericInput("MLanswer", "Answer:", value=0, min=0, max=100),
            actionButton("MLcounter", "Submit")),
    tabItem("MH", uiOutput("MHtable"),
            numericInput("MHanswer", "Answer:", value=0, min=0, max=100),
            actionButton("MHcounter", "Submit")),
    tabItem("HL", uiOutput("HLview"),
            numericInput("HLanswer", "Answer:", value=0, min=0, max=100),
            actionButton("HLcounter", "Submit")),
    tabItem("HH", uiOutput("HHtable"),
            numericInput("HHanswer", "Answer:", value=0, min=0, max=100),
